  ...
  return (
    ...
    <div className="flex shadow-md my-10">
      <div className="w-3/4 bg-white px-10 py-10">
        ...
        <Link to={'/'} className="flex font-semibold text-blue-900 text-sm mt-10">
      
          <svg className="fill-current mr-2 text-blue-900 w-4" viewBox="0 0 448 512"><path d="M134.059 296H436c6.627 0 12-5.373 12-12v-56c0-6.627-5.373-12-12-12H134.059v-46.059c0-21.382-25.851-32.09-40.971-16.971L7.029 239.029c-9.373 9.373-9.373 24.569 0 33.941l86.059 86.059c15.119 15.119 40.971 4.411 40.971-16.971V296z"/></svg>
          Continue Shopping
        </Link>
      </div>
      ...
      <div id="summary" className="w-1/4 px-8 py-10">
        ...
        <div className="border-t mt-8">
          ...
          <button className="bg-blue-900 font-semibold hover:bg-indigo-600 py-3 text-sm text-white uppercase w-full">Checkout</button>
        </div>
      </div>
