...
const Home = () => {
  return (
    <div className="bg-orange-100 h-100vh">
      <script src="https://kit.fontawesome.com/41c3693120.js" crossorigin="anonymous"/>
    <header className="bg-blue-800 sticky top-0">
      <nav className="flex justify-between align-center px-8 ">
        ...
        ></img>
        <input type="text" className="rounded-md w-1/2 m-3 px-3 font-medium " placeholder="Search a Product!"/>
        <div className='py-5'>
